...
public final class Image extends Table {
  ...
  public byte size() { int o = __offset(12); return o != 0 ? bb.get(o + bb_pos) : 1; }
  ...
  public static int createImage(FlatBufferBuilder builder,
    ...
    Image.addTitle(builder, title);
    Image.addUri(builder, uri);
  ...
  public static void addSize(FlatBufferBuilder builder, byte size) { builder.addByte(4, size, 1); }
