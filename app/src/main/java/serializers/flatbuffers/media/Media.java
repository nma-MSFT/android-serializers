...
public final class Media extends Table {
  ...
  public String person(int j) { int o = __offset(20); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int personLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public byte player() { int o = __offset(22); return o != 0 ? bb.get(o + bb_pos) : 1; }
  ...
  public Pod pods(int j) { return pods(new Pod(), j); }
  public Pod pods(Pod obj, int j) { int o = __offset(26); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int podsLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  ...
  public static int createMedia(FlatBufferBuilder builder,
    ...
    Media.addPods(builder, pods);
    Media.addCopyright(builder, copyright);
    Media.addPerson(builder, person);
    Media.addBitrate(builder, bitrate);
    Media.addFormat(builder, format);
    Media.addHeight(builder, height);
    Media.addWidth(builder, width);
    Media.addTitle(builder, title);
    Media.addUri(builder, uri);
  ...
  public static void addPerson(FlatBufferBuilder builder, int personOffset) { builder.addOffset(8, personOffset, 0); }
  ...
  public static void addPlayer(FlatBufferBuilder builder, byte player) { builder.addByte(9, player, 1); }
  public static void addCopyright(FlatBufferBuilder builder, int copyrightOffset) { builder.addOffset(10, copyrightOffset, 0); }
  public static void addPods(FlatBufferBuilder builder, int podsOffset) { builder.addOffset(11, podsOffset, 0); }
  public static int createPodsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startPodsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static int endMedia(FlatBufferBuilder builder) {
    int o = builder.endObject();
    builder.required(o, 12);  // format
    builder.required(o, 20);  // person
    builder.required(o, 26);  // pods
    return o;
  }
};
