...
abstract class BenchmarkBase
{
    ...
    protected final static class Params
    {
        ...
        public String dataFileName = "testfile";
    ...
    protected void runBenchmark(String[] args, InputStream testFile, int fileLength,
            TestCase testCreate,
            TestCase testSerialize, 
            TestCase testDeserialize) throws IOException {
    ...
    protected void findParameters(String[] args, Params params)
    {
        ...
        for (String arg : args) {
            ...
            if (option.equals("include")) {
                ...
                System.out.println();
                System.out.println("Example: run  -chart -include=protobuf,thrift  data/media.1.json");
                System.out.println();
                System.exit(0);
            }
            else if (option.equals("dataType")) {
                if (value != null) {
                    params.dataType = value;
                }
            }
            else if (option.equals("dataExtra")) {
                if (value != null) {
                    params.dataExtra = value;
                }
            }
            else if (option.equals("dataExtension")) {
                if (value != null) {
                    params.dataExtension = value;
                }
            }
            else {
        ...
        if (params.dataType == null || params.dataExtension == null || params.dataExtra == null) {
...
/*        byte[] fileBytes;
        ...
        try {
            return convertTestData(loader, params, fileContents);
        } catch (Exception ex) {
