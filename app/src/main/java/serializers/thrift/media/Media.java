...
public class Media implements org.apache.thrift.TBase<Media, Media._Fields>, java.io.Serializable, Cloneable, Comparable<Media> {
  ...
  private static final org.apache.thrift.protocol.TField PODS_FIELD_DESC = new org.apache.thrift.protocol.TField("pods", org.apache.thrift.protocol.TType.LIST, (short)12);
  ...
  private List<Pod> pods; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.COPYRIGHT, new org.apache.thrift.meta_data.FieldMetaData("copyright", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.PODS, new org.apache.thrift.meta_data.FieldMetaData("pods", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Pod.class))));
  ...
  public Media(Media other) {
    ...
    if (other.isSetPods()) {
      List<Pod> __this__pods = new ArrayList<Pod>(other.pods.size());
      for (Pod other_element : other.pods) {
        __this__pods.add(new Pod(other_element));
      }
      this.pods = __this__pods;
    }
  }
  ...
  public int getPodsSize() {
    return (this.pods == null) ? 0 : this.pods.size();
  }

  public java.util.Iterator<Pod> getPodsIterator() {
    return (this.pods == null) ? null : this.pods.iterator();
  }

  public void addToPods(Pod elem) {
    if (this.pods == null) {
  ...
  public void unsetPods() {
    this.pods = null;
  }

  /** Returns true if field pods is set (has been assigned a value) and false otherwise */
  public boolean isSetPods() {
    return this.pods != null;
  }

  public void setPodsIsSet(boolean value) {
    if (!value) {
      this.pods = null;
    }
  }
  ...
  public boolean equals(Media that) {
    ...
    boolean this_present_pods = true && this.isSetPods();
    boolean that_present_pods = true && that.isSetPods();
    if (this_present_pods || that_present_pods) {
      if (!(this_present_pods && that_present_pods))
        return false;
      if (!this.pods.equals(that.pods))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_pods = true && (isSetPods());
    list.add(present_pods);
    if (present_pods)
      list.add(pods);
  ...
  public int compareTo(Media other) {
    ...
    lastComparison = Boolean.valueOf(isSetPods()).compareTo(other.isSetPods());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPods()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.pods, other.pods);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void validate() throws TException {
    ...
    if (!isSetPods()) {
      throw new TProtocolException("Required field 'pods' is unset! Struct:" + toString());
    }
  ...
  private static class MediaStandardScheme extends StandardScheme<Media> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Media struct) throws TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pods = new ArrayList<Pod>(_list3.size);
                Pod _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new Pod();
                  _elem4.read(iprot);
                  struct.pods.add(_elem4);
                }
                iprot.readListEnd();
              }
              struct.setPodsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Media struct) throws TException {
      struct.validate();
      ...
      if (struct.person != null) {
        oprot.writeFieldBegin(PERSON_FIELD_DESC);
        {
          ...
          for (String _iter6 : struct.person)
          {
      ...
      if (struct.pods != null) {
        oprot.writeFieldBegin(PODS_FIELD_DESC);
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.pods.size()));
          for (Pod _iter7 : struct.pods)
          {
            _iter7.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MediaTupleScheme extends TupleScheme<Media> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Media struct) throws TException {
      ...
      oprot.writeI64(struct.size);
      {
        ...
        for (String _iter8 : struct.person)
        {
      ...
      oprot.writeI32(struct.player.getValue());
      {
        oprot.writeI32(struct.pods.size());
        for (Pod _iter9 : struct.pods)
        {
          _iter9.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Media struct) throws TException {
      ...
      struct.setSizeIsSet(true);
      {
        ...
        struct.person = new ArrayList<String>(_list10.size);
        String _elem11;
        for (int _i12 = 0; _i12 < _list10.size; ++_i12)
        {
          _elem11 = iprot.readString();
          struct.person.add(_elem11);
        }
      }
      struct.setPersonIsSet(true);
      struct.player = serializers.thrift.media.Player.findByValue(iprot.readI32());
      struct.setPlayerIsSet(true);
      {
        ...
        struct.pods = new ArrayList<Pod>(_list13.size);
        Pod _elem14;
        for (int _i15 = 0; _i15 < _list13.size; ++_i15)
        {
          _elem14 = new Pod();
          _elem14.read(iprot);
          struct.pods.add(_elem14);
        }
      }
      struct.setPodsIsSet(true);
